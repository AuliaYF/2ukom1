...
import auliayf.bn.models.MataDiklatModel;
import auliayf.bn.tables.MataDiklatTable;
 ...
 */
public class MataDiklatView extends javax.swing.JFrame {
    ...
    private void refresh() {
        db.Query q = new db.Query("mata_diklat");
        List<db.Model> models = db.query(q);

        MataDiklatTable table = new MataDiklatTable(models);
    ...
    private void initComponents() {
        ...
        setTitle("Mata Diklat");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(0, 204, 204));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        jLabel2.setText("Mata Diklat");
        ...
        jLabel3.setText("Nama Mata Diklat");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!isInEditable) {
            ...
            int result = -1;
            if (mode == 0) {
                result = MataDiklatModel.insert(jTextField1.getText(), jTextField2.getText());
            } else {
                result = MataDiklatModel.update(jTextField1.getText(), jTextField2.getText());
            }
            if (result == 1) {
                refresh();
                clean();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        db.Query q = new db.Query("mata_diklat");
        q.like("kode_mata_diklat", jTextField3.getText());
        q.or_like("nama_mata_diklat", jTextField3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selected >= 0) {
            ...
            if (result == 0) {
                int result2 = MataDiklatModel.delete(jTable1.getValueAt(selected, 0).toString());
                if (result2 == 1) {
                    refresh();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MataDiklatView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MataDiklatView().setVisible(true);
            }
        });
    }
