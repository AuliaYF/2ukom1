...
import auliayf.bn.combo.MataDiklatCombo;
import auliayf.bn.core.db;
import auliayf.bn.models.KompetensiKeahlianModel;
import auliayf.bn.tables.KompetensiKeahlianTable;
 ...
 */
public class KompetensiKeahlianView extends javax.swing.JFrame {
     ...
     */
    public KompetensiKeahlianView() {
        initComponents();

        refresh();
        
        jComboBox1.setModel(new MataDiklatCombo());
        jComboBox1.setSelectedIndex(0);
    }

    private void refresh() {
        db.Query q = new db.Query("kompetensi_keahlian");
        q.join("mata_diklat", "mata_diklat.kode_mata_diklat = kompetensi_keahlian.kode_mata_diklat", "");
        List<db.Model> models = db.query(q);

        KompetensiKeahlianTable table = new KompetensiKeahlianTable(models);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kode Mata Diklat");

        jLabel3.setText("Nama Kompetensi");
        ...
        jLabel4.setText("Kode Kompetensi");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!isInEditable) {
            ...
            if (mode == 0) {
                ...
                result = KompetensiKeahlianModel.update(jTextField1.getText(), jComboBox1.getSelectedItem().toString().split(" ")[0], jTextField2.getText());
            }
            if (result == 1) {
                refresh();
                clean();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        db.Query q = new db.Query("kompetensi_keahlian");
        q.join("mata_diklat", "mata_diklat.kode_mata_diklat = kompetensi_keahlian.kode_mata_diklat", "");
        q.like("kode_kk", jTextField3.getText());
        q.or_like("kompetensi_keahlian.kode_mata_diklat", jTextField3.getText());
        q.or_like("nama_kompetensi_keahlian", jTextField3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selected >= 0) {
            ...
            if (result == 0) {
                int result2 = KompetensiKeahlianModel.delete(jTable1.getValueAt(selected, 0).toString());
                if (result2 == 1) {
                    refresh();
