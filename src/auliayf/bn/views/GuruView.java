...
import auliayf.bn.tables.GuruTable;
...
public class GuruView extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!isInEditable) {
            ...
            int result;
            if (mode == 0) {
                result = GuruModel.insert(jTextField1.getText(), jComboBox1.getSelectedItem().toString().split(" ")[0], jTextField2.getText(), jTextField4.getText(), jTextArea1.getText(), jTextField5.getText());
            } else {
                result = GuruModel.update(jTextField1.getText(), jComboBox1.getSelectedItem().toString().split(" ")[0], jTextField2.getText(), jTextField4.getText(), jTextArea1.getText(), jTextField5.getText());
            }
            if (result == 1) {
                refresh();
                clean();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        db.Query q = new db.Query("guru");
        q.join("kompetensi_keahlian", "kompetensi_keahlian.kode_kk = guru.kode_kk", "");
        q.like("kode_guru", jTextField3.getText());
        q.or_like("guru.kode_kk", jTextField3.getText());
        q.or_like("nama_guru", jTextField3.getText());
        q.or_like("nip", jTextField3.getText());
        q.or_like("alamat_guru", jTextField3.getText());
        q.or_like("telp_guru", jTextField3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selected >= 0) {
            ...
            if (result == 0) {
                int result2 = GuruModel.delete(jTable1.getValueAt(selected, 0).toString());
                if (result2 == 1) {
                    refresh();
