...
import auliayf.bn.models.StandarKompetensiModel;
import auliayf.bn.tables.StandarKompetensiTable;
...
public class StandarKompetensiView extends javax.swing.JFrame {
    ...
    private void refresh() {
        db.Query q = new db.Query("standar_kompetensi");
        q.join("kompetensi_keahlian", "kompetensi_keahlian.kode_kk = standar_kompetensi.kode_kk", "");
        List<db.Model> models = db.query(q);

        StandarKompetensiTable table = new StandarKompetensiTable(models);
    ...
    private void initComponents() {
        ...
        setTitle("Standar Kompetensi");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(0, 204, 204));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        jLabel2.setText("Standar Kompetensi");
        ...
        jLabel4.setText("Kode SK");

        jTextField4.setEditable(false);

        jLabel5.setText("Kelas SK");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!isInEditable) {
            ...
            int result = -1;
            if (mode == 0) {
                result = StandarKompetensiModel.insert(jTextField1.getText(), jComboBox1.getSelectedItem().toString().split(" ")[0], jTextField2.getText(), jTextField4.getText());
            } else {
                result = StandarKompetensiModel.update(jTextField1.getText(), jComboBox1.getSelectedItem().toString().split(" ")[0], jTextField2.getText(), jTextField4.getText());
            }
            if (result == 1) {
                refresh();
                clean();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        db.Query q = new db.Query("standar_kompetensi");
        q.join("kompetensi_keahlian", "kompetensi_keahlian.kode_kk = standar_kompetensi.kode_kk", "");
        q.like("kode_sk", jTextField3.getText());
        q.or_like("standar_kompetensi.kode_kk", jTextField3.getText());
        q.or_like("nama_sk", jTextField3.getText());
        q.or_like("kelas_sk", jTextField3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (selected >= 0) {
            ...
            if (result == 0) {
                int result2 = StandarKompetensiModel.delete(jTable1.getValueAt(selected, 0).toString());
                if (result2 == 1) {
                    refresh();
