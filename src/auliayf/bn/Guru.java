...
public class Guru extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/b_chart.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        HashMap<String, Object> param = new HashMap<>();
        param.put("kode_guru", Session.CURRENT_USER.get("kode_kk"));

        ReportView rpt = new ReportView("grafik_nilai_guru", param);
        rpt.callReport();
